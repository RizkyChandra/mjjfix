    ...
    <div className="min-h-screen min-w-screen bg-gray-100 flex justify-center items-center">
      <div className="container flex flex-col md:flex-row items-center justify-center px-2 text-gray-700">
        <div className="max-w-md">
          ...
          <p className="mb-8">
            Tapi jangan khawatir, kamu dapat menemukan banyak hal lain
            diberanda.
          </p>
        ...
        <div className="max-w-lg">
          ...
          >
            ...
            <path
              ...
              stroke="#000"
              strokeWidth="3"
              d="M292.3 344.49l-28.05-15.3a40.34 40.34 0 01-20.8-39.64l2.35-22.21a61.8 61.8 0 0126.57-44.52h0a29.52 29.52 0 0129.48-2.22 82.16 82.16 0 008.28 3.32 234.66 234.66 0 0186.78 54.37l-43.47 78.83z"
              className="cls-17"
            ></path>
            <path
              fill="#DA4E22"
            ...
            <path
              ...
              stroke="#000"
              strokeWidth="3"
              d="M393 455.33l-49.4-22.83a42.53 42.53 0 01-21-55.8l10.27-23.18a56 56 0 0170.16-30l59.18 21.35A54.61 54.61 0 01497.69 404h0a72.53 72.53 0 01-17.51 34.08c-22.74 24.35-55.11 23-60.87 22.72a83.93 83.93 0 01-26.31-5.47zM220.48 538.45l-4.1-14.15a39.86 39.86 0 0120.26-46.64h0a44.74 44.74 0 0146.87 4c12.59 4.22 69.55 24.82 98.81 84.49a161.75 161.75 0 0116.25 66.83 8.26 8.26 0 01-12.57 7.19zM173.88 677.25L191 690a87.06 87.06 0 0016.42 9.6 175.79 175.79 0 0021.43 7.83c15.81 4.64 54.81 16.06 98.18.1 33.26-12.24 53.93-35 64.71-49.86a7 7 0 00-4.9-11.16l-188.3-21.35a32.86 32.86 0 00-33 17.77 27.41 27.41 0 008.34 34.32z"
              className="cls-17"
            ></path>
            <path
              fill="#DA4E22"
